...
public class WebMvcConfiguration implements WebMvcConfigurer {
  ...
  public void addViewControllers(ViewControllerRegistry registry) {
    ...
    // Map "/word", "/word/word", and "/word/word/word" - except for anything starting with
    // "/api/..." or ending with
    // a file extension like ".js" - to index.html. By doing this, the client receives and routes
    // the url. It also
